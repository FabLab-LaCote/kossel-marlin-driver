...
// Ultimaker
    #define  DEFAULT_Kp 57.48
    #define  DEFAULT_Ki 8.12
    #define  DEFAULT_Kd 101.72
...
#define MANUAL_Z_HOME_POS 251.20  // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_RETRACT_ACCELERATION  15000   // X, Y, Z and E max acceleration in mm/s^2 for retracts

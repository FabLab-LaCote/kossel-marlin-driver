...
#define MANUAL_Z_HOME_POS 249.4  // For delta: Distance between nozzle and print surface after homing.
...
#define Z_PROBE_OFFSET {0, 10, -3, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
